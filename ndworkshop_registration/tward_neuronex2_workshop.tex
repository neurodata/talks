...
%For the first time, we quantify 3D density of Tau tangles throughout medial temporal lobe.
\vspace{-0.0em}

%\includegraphics<1>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-0.png}%
%\includegraphics<2>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-1.png}%
%\includegraphics<3>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-2.png}%
%\includegraphics<4>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-3.png}%
%\includegraphics<5>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-4.png}%
%\includegraphics<6>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-5.png}%
%\includegraphics<7>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-6.png}%
%\includegraphics<8>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-7.png}%
\includegraphics<1>[width=0.95\textwidth,clip,trim=2.5in 4in 2.0in 2in]{output-8.png}%
%\includegraphics<10>[width=\textwidth,clip,trim=2.5in 4in 2.0in 0in]{output-9.png}%
%\includegraphics<11>[width=\textwidth,clip,trim=2.5in 4in 2.0in 0in]{output-10.png}%
%show a few pages
